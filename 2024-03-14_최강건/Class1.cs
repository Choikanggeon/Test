...
namespace _2024_03_14_최강건
{
    internal class Class1
    {
        ...
        작은 경우 왼쪽자식노드로...큰 경우라면 오른쪽으로 감.
        1)23과 17을 비교 ==>(17 < 23) ->왼쪽으로감.
          ㄴ이제 오른쪽 서브트리는 탐색할 필요가 없음
        2)11과 17을 비교 ==>(17 > 11) ->오른쪽으로감.
          ㄴ이제 왼쪽.왼쪽 서브트리는 탐색할 필요가 없음
        3)19와 17을 비교 ==>(17 < 19) ->왼쪽으로감.
        4)17이랑 17 비교 ==>같음!(찾음)
        //             23(↙)
        //      ┌──────┴──────┐
        //      11(↘)        38
       ...
       [삽입]
        ...
        //3. 자식이 2개인 경우 : 삭제하는 노드를 기준으로 오른쪽 자식중 가장 작은값 노드와 
        // 교체후 삭제
        // 23을 삭제한다면?
        //                                                        
        //            (23)                     24                      24           
        ...
        */
        ...
        public class BinarySearchTree<T> where T : IComparable<T>
        {
            ...
            public bool Add(T item)
            {
                ...
                while (current != null)
                {
                    if(item.CompareTo(current.item) < 0)//CompareTo현재객체가 다른 객체보다 크면 양수 다르면 음수
                    {
            ...
            {
                if(node.left == null && node.right == null)//자식이 없는경우
                {
